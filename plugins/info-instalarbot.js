...
- git clone https://github.com/MESIASREYES/Fenix-Bot-CD.git && cd Fenix-Bot-CD
- yarn install
- npm install
- npm update
- npm start
...
> npm start`.trim();
  const buttonMessage= {
    'document': {url: `https://github.com/MESIASREYES/Fenix-Bot-CD`},
    ...
    'contextInfo': {
      ...
      'isForwarded': true,
      'externalAdReply': {
        'mediaUrl': 'https://github.com/MESIASREYES/Fenix-Bot-CD',
        'mediaType': 2,
        'previewType': 'pdf',
